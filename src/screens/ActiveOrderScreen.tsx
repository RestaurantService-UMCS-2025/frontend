...
export const ActiveOrderScreen = () => {
    ...
    if (!order) return <div className="animated-view" style={{ textAlign: 'center', marginTop: '50px' }}><h3>Brak aktywnego zamówienia.</h3></div>;

    return (
        <div className="animated-view">
            <h1>Twoje Zamówienie <span style={{ color: 'var(--text-muted)' }}>#{order.id}</span></h1>
